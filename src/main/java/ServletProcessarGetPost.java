 ...
 * @author osmar
 */
public class ServletProcessarGetPost extends HttpServlet {
    ...
    public void processar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
